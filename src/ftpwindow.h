...
public:
  ...
  void uploadAllFile(QString rootDir); //上传的真正操作函数
...
private slots:
  ...
  // 上传
  void uploadFile();
  void localProgressDialog();
  void localDataTransferProgress(qint64 readBytes, qint64 totalBytes);
